...
% Allow writing above/below arrows
...
% Final package: example in linguistics format
%\usepackage{gb4e}
%\noautomath % Turn of redefinition for underscores from gb4e
...
\fancyhead[L]{Index of Figures/Tables/Listings} %Kopfzeile links
...
\input{latex_einstellungen/abbreviations/abbreviations}
